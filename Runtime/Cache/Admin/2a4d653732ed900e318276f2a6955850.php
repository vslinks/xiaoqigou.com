    ...
    <div class="row">
                            ...
                            <div class="col-sm-7" id="cluster_info">
                                <dl class="dl-horizontal">
                                    ...
                                    <dd class="project-people">
                                        ...
                                        <a href="project_detail.html">
                                            <img alt="image" class="img-circle" src="http://vslinks.shop.com/Public/Admin/ext/blog/img/a5.jpg">
                                        </a>
                                    </dd>
                                </dl>
                            </div>
        ...
        <div class="col-sm-3">
            <div class="wrapper wrapper-content project-manager">
                <h4>项目描述</h4>
                <img src="http://vslinks.shop.com/Public/Admin/ext/blog/img/wenku_logo.png" class="img-responsive">
                <p class="small">
