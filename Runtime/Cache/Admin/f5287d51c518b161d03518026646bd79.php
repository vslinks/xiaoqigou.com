                        ...
                        <div class="m-t-md">
                            ...
                            <div class="p-lg ">
                                <a href="index_v5.html" target="_blank">
                                    <img class="img-responsive img-shadow" src="http://vslinks.shop.com/Public/Admin/ext/blog/img/index_4.jpg" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content text-center p-md">
                        ...
                        <div class="m-t-md">
                            ...
                            <div class="p-lg">
                                <a href="javascript:;">
                                    <img class="img-responsive img-shadow" src="http://vslinks.shop.com/Public/Admin/ext/blog/img/index.jpg" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
