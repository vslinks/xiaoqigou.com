            ...
            <div class="col-sm-6">
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" href="tabs_panels.html#tab-1" aria-expanded="true"> 第一个选项卡</a>
                        </li>
                        <li class=""><a data-toggle="tab" href="tabs_panels.html#tab-2" aria-expanded="false">第二个选项卡</a>
                        </li>
                    </ul>
        ...
        <div class="row m-b-lg">
            <div class="col-sm-6">
                <div class="tabs-container">
                    ...
                    <div class="tabs-left">
                        <ul class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab" href="tabs_panels.html#tab-8"> 第一个选项卡</a>
                            </li>
                            <li class=""><a data-toggle="tab" href="tabs_panels.html#tab-9"> 第二个选项卡</a>
                            </li>
                        </ul>
                        <div class="tab-content ">
            ...
            <div class="col-sm-6">
                <div class="tabs-container">
                    <div class="tabs-right">
                        <ul class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab" href="tabs_panels.html#tab-10">第一个选项卡</a>
                            </li>
                            <li class=""><a data-toggle="tab" href="tabs_panels.html#tab-11"> 第二个选项卡</a>
                            </li>
                        </ul>
                        <div class="tab-content ">
