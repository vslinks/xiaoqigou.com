...
<head>
    ...
    <link href="./Public/Admin/ext/blog/css/plugins/steps/jquery.steps.css" rel="stylesheet">
...
<body class="gray-bg">
    ...
    <script src="./Public/Admin/ext/blog/js/plugins/staps/jquery.steps.min.js"></script>
    <script src="./Public/Admin/ext/blog/js/plugins/validate/jquery.validate.min.js"></script>
    <script src="./Public/Admin/ext/blog/js/plugins/validate/messages_zh.min.js"></script>
    <script>
