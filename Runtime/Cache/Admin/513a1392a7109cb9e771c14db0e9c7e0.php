...
<head>
    ...
    <link rel="shortcut icon" href="favicon.ico"> <link href="./Public/Admin/ext/blog/css/bootstrap.min.css" rel="stylesheet">
    <link href="./Public/Admin/ext/blog/css/font-awesome.min.css" rel="stylesheet">

    <!-- Morris -->
    <link href="./Public/Admin/ext/blog/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">

    <link href="./Public/Admin/ext/blog/css/animate.min.css" rel="stylesheet">
    <link href="./Public/Admin/ext/blog/css/style.min.css" rel="stylesheet"><base target="_blank">
...
<body class="gray-bg sidebar-content">
    ...
    <script src="./Public/Admin/ext/blog/js/plugins/flot/jquery.flot.js"></script>
    <script src="./Public/Admin/ext/blog/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="./Public/Admin/ext/blog/js/plugins/flot/jquery.flot.spline.js"></script>
    <script src="./Public/Admin/ext/blog/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="./Public/Admin/ext/blog/js/plugins/flot/jquery.flot.pie.js"></script>
    <script src="./Public/Admin/ext/blog/js/plugins/flot/jquery.flot.symbol.js"></script>
    <script src="./Public/Admin/ext/blog/js/plugins/flot/curvedLines.js"></script>
    <script src="./Public/Admin/ext/blog/js/plugins/peity/jquery.peity.min.js"></script>
    <script src="./Public/Admin/ext/blog/js/demo/peity-demo.min.js"></script>
    <script src="./Public/Admin/ext/blog/js/content.min.js@v=1.0.0"></script>
    <script src="./Public/Admin/ext/blog/js/plugins/jquery-ui/jquery-ui.min.js"></script>
    <script src="./Public/Admin/ext/blog/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="./Public/Admin/ext/blog/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
    <script src="./Public/Admin/ext/blog/js/plugins/easypiechart/jquery.easypiechart.js"></script>
    <script src="./Public/Admin/ext/blog/js/plugins/sparkline/jquery.sparkline.min.js"></script>
    <script src="./Public/Admin/ext/blog/js/demo/sparkline-demo.min.js"></script>
    <script>
