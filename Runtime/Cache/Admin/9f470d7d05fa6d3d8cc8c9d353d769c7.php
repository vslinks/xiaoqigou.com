...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://vslinks.shop.com/Public/Admin/ext/tree_grid/css/jquery.tree_grid.css" />
    ...
    <form method="post" action="" name="listForm">
        <div class="list-div" id="listDiv">
            <table cellpadding="3" cellspacing="1" class="tree">
                ...
                <!-- 下面这个是添加两个 类 ,一个是以当前id 结尾的  一个是用于判断 是否是父级-->
                <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr align="center" class='treegrid-<?php echo ($row["id"]); ?> <?php if(($row["parent_id"]) != "0"): ?>treegrid-parent-<?php echo ($row["parent_id"]); endif; ?>'>
...
<!--下面这个是为 js  预留的位置-->
    ...
    <script type="text/javascript" src="http://vslinks.shop.com/Public/Admin/ext/tree_grid/js/jquery.tree_grid.js"></script>
