...
<body class="gray-bg top-navigation">
                            ...
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    ...
                                    <div class="ibox-tools">
                                        ...
                                        <a class="dropdown-toggle" data-toggle="dropdown" href="index_v5.html#">
                                            <i class="fa fa-wrench"></i>
                                        </a>
                                        <ul class="dropdown-menu dropdown-user">
                                            <li><a href="index_v5.html#">设置选项1</a>
                                            </li>
                                            <li><a href="index_v5.html#">设置选项2</a>
                                            </li>
                                        </ul>
                                        <a class="close-link">
    ...
    <script src="http://vslinks.shop.com/Public/Admin/ext/blog/js/plugins/charthttp://vslinks.shop.com/Public/Admin/ext/blog/js/Chart.min.js"></script>
