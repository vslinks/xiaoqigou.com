...
<head>
    ...
    <link href="./Public/Admin/ext/blog/css/style.min.css@v=4.0.0" rel="stylesheet">
...
<body class="gray-bg">
            ...
            <div class="col-sm-6">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form action="http://www.zi-han.net/theme/hplus/index_submit" method="get" accept-charset="utf-8" role="form">
                            <hr>
                            <h3>测试(URL 获取)</h3>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <article class="markdown-body entry-content" itemprop="mainContentOfPage">
                            ...
                            <h1><a id="user-content-bootstrap-search-suggest" class="anchor" href="suggest.html#bootstrap-search-suggest" aria-hidden="true"><span class="octicon octicon-link"></span></a>Bootstrap Search Suggest</h1>
    ...
    keyEnter: 13                    //回车键
                            ...
                            <h2><a id="user-content-note-on-patches--pull-requests" class="anchor" href="suggest.html#note-on-patches--pull-requests" aria-hidden="true"><span class="octicon octicon-link"></span></a>Note on Patches / Pull Requests</h2>
                            ...
                            <h2><a id="user-content-设计制作" class="anchor" href="suggest.html#设计制作" aria-hidden="true"><span class="octicon octicon-link"></span></a>设计制作</h2>
